...
public class IdentityData extends AbstractData<IdentityData, IdentityData.Immutable> {
    ...
    protected void registerGettersAndSetters () {
        ...
        registerFieldGetter(IdentityKeys.IDENTITY, this::getIdentity);
        registerFieldSetter(IdentityKeys.IDENTITY, this::setIdentity);
        registerKeyValue(IdentityKeys.IDENTITY, this::identity);
    }
    ...
    public Value<UUID> identity () {
        ...
        return Sponge.getRegistry().getValueFactory().createValue(IdentityKeys.IDENTITY, identity);
    }
    ...
    public Optional<IdentityData> from (DataView container) {
        ...
        container.getObject(IdentityKeys.IDENTITY.getQuery(), UUID.class).ifPresent(v->identity = v);
        return Optional.of(this);
    }
    ...
    public DataContainer toContainer () {
        ...
        return super.toContainer().set(IdentityKeys.IDENTITY.getQuery(), identity);
    }
    ...
    public static class Immutable extends AbstractImmutableData<Immutable, IdentityData> {
        ...
        public ImmutableValue<UUID> identity () {
            ...
            return Sponge.getRegistry().getValueFactory().createValue(IdentityKeys.IDENTITY, identity).asImmutable();
        }
